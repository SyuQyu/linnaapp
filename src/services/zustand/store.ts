...
import createDepartmentSlice, {
  DepartmentSlice,
} from "./department/departmentSlice";
import createOfficeSlice, { OfficeSlice } from "./office/officeSlice";
import { createJSONStorage, persist, StateStorage } from "zustand/middleware";

export type StoreState = AppSlice & UserSlice & DepartmentSlice & OfficeSlice;
